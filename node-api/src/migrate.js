...
async function migrate() {
  ...
  // --- pedidos_operacionais (CEP — dados estatísticos simulados) ---
  await conn.query(`
    CREATE TABLE IF NOT EXISTS pedidos_operacionais (
      ...
      CONSTRAINT fk_pedidos_op_hortas FOREIGN KEY (hortas_id_hortas)
        REFERENCES hortas(id_hortas)
        ON DELETE CASCADE ON UPDATE CASCADE
    )
  `);
  console.log('  ✅ pedidos_operacionais');
